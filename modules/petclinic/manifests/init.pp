...
command => '/usr/bin/curl -o petclinic.war http://35.196.3.240:8081/artifactory/libs-snapshot-local/org/springframework/samples/spring-petclinic/1.0.1-SNAPSHOT/spring-petclinic-1.0.1-20180614.182937-2.war',
